    ...
    return (
        <>
            ...
            <Row className="mt-2">
                <Col>
                    <RadioButtons
                        variableName="trustCommitmentType"
                        values={[C_HELD_BY_UIF, C_HELD_BY_OTHERS, C_REVOCABLE]}
                ...
                <Col xs={12} md={3}>
                    {getValues("trustCommitmentType") === C_HELD_BY_UIF && (
                        <FormControl fullWidth required>
                            ...
                            >
                                <MenuItem value={"Charitable Gift Annuity"}>
                                    Charitable Gift Annuity
                                </MenuItem>
                                <MenuItem value={"Charitable Remainder Trust"}>
                                    Charitable Remainder Trust
                                </MenuItem>
                                <MenuItem
                                    value={"Charitable Remainder Annuity Trust"}
                                >
                                    Charitable Remainder Annuity Trust
                                </MenuItem>
                                <MenuItem value={"Deferred Gift Annuity"}>
                                    Deferred Gift Annuity
                                </MenuItem>
                                <MenuItem value={"Charitable Lead Unitrust"}>
                                    Charitable Lead Unitrust
                                </MenuItem>
                                <MenuItem value={"Charitable Annuity Trust"}>
                                    Charitable Annuity Trust
                                </MenuItem>
                                <MenuItem value={"Retained Life Estate"}>
                    ...
                    {getValues("trustCommitmentType") === C_HELD_BY_OTHERS && (
                        <FormControl fullWidth required>
                            ...
                            >
                                <MenuItem value={"Charitable Lead Trust"}>
                                ...
                                <MenuItem
                                    value={"Charitable Lead Annuity Trust"}
                                >
