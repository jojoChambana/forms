...
export default function TrustDataEntry({
    ...
    function OtherTrustTypeSelected() {
        return ((getValues("trustType") !== "Deferred Gift Only") && (getValues("trustType") !== ""))
                ...
                <RadioGroup
                    ...
                    onChange={(event) => {
                        ...
                        if (event.target.value === "Life Insurance") {
                            ...
                            setValue("designation.0.tedDesignationId","19330016")
                            setValue("designation.0.tedDesignationTitle","Life Insurance Premium")
                        }
                        else {
                            //  see if the designation used to be the one hard-coded for life insurance.  If it is, remove it
                            if (getValues("designation.0.tedDesignationId") === "19330016") {
                                setValue("designation.0.tedDesignationId","")
                                setValue("designation.0.tedDesignationTitle","")
                            }
                        }
                    ...
                    name="trustType"
                >
                    <FormControlLabel value="Outright" control={<Radio />} label="Outright" />
                    <FormControlLabel value="Estate" control={<Radio />} label="Estate" />
                    <FormControlLabel value="Life Income" control={<Radio />} label="Life Income" />
                    <FormControlLabel value="Life Insurance" control={<Radio />} label="Life Insurance" />
                </RadioGroup>
                </Col>
            </Row>            
            {OtherTrustTypeSelected() && 
            <>
                <TrustDepartmentInformation trustType={getValues("trustType")} />
