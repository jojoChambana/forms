    ...
    return (
        <>
            ...
            <Row>
                <Col>
                    <RadioButtons
                        variableName="increaseDecreasePrior"
                        label="Increase/Decrease Prior?"
                        values={["Yes", "No"]}
                ...
                <Col>
                    <RadioButtons
                        variableName="jointLifeGift"
                        label="Joint Life Gift"
                        values={["Yes", "No"]}
                        radioChangedFlag={aCheckboxChanged}
                        setRadioChangedFlag={setaCheckboxChanged}
                    />
            ...
            <Row>
                ...
                <Col>
                    <RadioButtons
                        variableName="fundAgreement"
                        label="Fund Agreement"
                        values={[
                            "UIF existing",
                            "UIF in process",
                            "In will/trust",
