...
const PrintOneDesignation = ({ oneDesignation, index, key }) => {
    return (
        <li className="list-group-item" key={oneDesignation.id}>
            ...
            <div>Designation Title: {oneDesignation.tedDesignationTitle}</div>
            <div>
                Gift Amount:{" "}
