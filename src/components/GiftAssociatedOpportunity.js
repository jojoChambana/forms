...
export default function GiftAssociatedOpportunity() {
    ...
    return (
        <FormGroup>
            <Row className='mb-0'>
                <Col>
                    <FormControlLabel label="Check if this gift is associated with an opportunity" control={<Checkbox placeholder="Is this gift associated with an opportunity" {...register("associatedOpportunity")} onChange={handleChange} />} />
                </Col>
            </Row>
            {visable && (
                <>
                    <Row>
                        ...
                        <Col xs={12} md={8}><TextField {...register("tedHousehold Name")} required placeholder="Household name" label="Household name" className="maxWidth" /></Col>
                    </Row>
                    <Row>
