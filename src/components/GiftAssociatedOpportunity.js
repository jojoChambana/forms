...
export default function GiftAssociatedOpportunity({ register, errors }) {
    ...
    return (
        <>
            <Typography variant="h6" component="h4">Opportunity</Typography>
            <FormGroup>
                <Row className='mb-0'>
                    <Col>
                        <FormControlLabel label="Check if this gift is associated with an opportunity" control={<Checkbox {...register(`associatedOpportunity`)} placeholder="Is this gift associated with an opportunity" onChange={handleChange} />} />
                        <ErrorMessage errors={errors} name="associatedOpportunity" />
                    </Col>
                </Row>
                {visable && (
                    <>
                        ...
                        <Row>
                            ...
                            <Col xs={12} md={4}>
                                <div className='dollarAmount'>
                                    <TextField {...register("tedOpportunityAmount")} required placeholder="Opportunity amount" label="Opportunity amount" className="maxWidth" />
                                </div>
                            </Col>
                        </Row>
                        <Row>
                            ...
                            <Col xs={12} md={6}><TextField {...register("primaryPlanManager")} required placeholder="Primary plan manager name" label="Primary plan manager name" className="maxWidth" /></Col>
                        </Row>
                    </>
                )}
            </FormGroup>
